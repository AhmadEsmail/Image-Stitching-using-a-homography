...
// Detect features
	...
	// Normalize the coordinates of the point correspondences 
	...
	Mat transformedImage = Mat::zeros(1.8*image1.size().height,1.5*image1.size().width, image1.type());
